...
// const newsletterUrl = 'https://www.course-api.com/react-tours-project';
    ...
    return (
        ...
        <Form className='form' method='POST'>
            ...
            <div className="form-row">
                ...
                <input type="text" className='form-input' name='email' id='email' required defaultValue='test@test.com'/>
            </div>
